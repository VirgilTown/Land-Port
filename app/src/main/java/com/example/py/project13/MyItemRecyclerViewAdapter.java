...
import com.example.py.project13.ItemFragment.OnListFragmentInteractionListener;
import com.example.py.project12.R;
import com.example.py.project13.dummy.WordsContent.WordItem;
...
public class MyItemRecyclerViewAdapter extends RecyclerView.Adapter<MyItemRecyclerViewAdapter.ViewHolder> {
    ...
    public MyItemRecyclerViewAdapter(List<WordsContent.WordItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
